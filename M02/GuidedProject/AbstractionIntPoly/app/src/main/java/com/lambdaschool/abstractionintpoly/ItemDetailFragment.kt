...
class ItemDetailFragment : Fragment() {
        ...
        arguments?.let {
            if (it.containsKey(ARG_ITEM_ID)) {
                ...
                activity?.toolbar_layout?.let { layout ->
                    ...
                    val cat = item?.category ?: "null category"
                    layout.title = item?.name ?: ""


                 /*
                    if (cat == DrawableResolver.CHARACTER) {

                    } else if  (cat == DrawableResolver.STARSHIP) {
                        layout.title = item?.name ?: ""
                    }*/
    ...
    override fun onCreateView(
       ...
       /* btn.setOnClickListener{
            ...
            responseObject?.provideInforForObjects(item?.info() ?: "No info") ?:""
        }*/
    ...
    interface DetailResponse {
        fun provideInforForObjects(info:String)
