...
class ItemListActivity : AppCompatActivity(),ItemDetailFragment.DetailResponse {
    override fun provideInforForObjects(info: String) {
        Toast.makeText(this, "wegot iufnos $info", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun getData() {
        ...
        // Add people
            val personIds = mutableListOf(15,5,12,13,5,6)
            //personIds.shuffle()
            personIds.forEach {
                getPerson(it)
        ...
        // Add starships
        val starshipIds = mutableListOf(15,5,12,13,5,6)
        //personIds.shuffle()
        starshipIds.forEach {
            getStarship(it)
        }
    ...
    fun getPerson(id:Int) {
        starWarsAPI.getPerson(id).enqueue(object : Callback<Person> {
            override fun onFailure(call: Call<Person>, t: Throwable) {
                progressBar.visibility = View.INVISIBLE // View.GONE
            }
    ...
    class SimpleItemRecyclerViewAdapter(
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.nameView.text = swApiObject.name ?: "null value caught"
